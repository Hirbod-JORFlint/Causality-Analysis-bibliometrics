...
"""
This script creates a time series for each keyword in a provided list by counting its occurrence in the 'Keywords' column of a dataset for each year.
...
9. Save the dataframe to a new CSV file.
"""
# Load the dataset
time_df = pd.read_csv('math.csv')

# Lowercase the keywords
time_df['Keywords'] = time_df['Keywords'].str.lower().str.strip()

# Split the 'Keywords' column into a list of keywords
time_df['Keywords'] = time_df['Keywords'].str.split(';')
...
keyword1= ['pathology', 'information visualization', 'artificial intelligence', 'shock', 'transfer function', 'science education research', 'plasma physics', 'interaction design', 'clustering', 'label placement', 'dot gain', 'image based lighting', 'volume rendering', 'visualization techniques', 'digital pathology', 'automation', 'technology education', 'air traffic control', 'interaction', 'visualization', 'computer vision', 'haptics', 'user interfaces', 'evolution', 'laser plasma', 'machine learning', 'medical imaging', 'parallel coordinates', 'compressed sensing', 'scientific visualization', 'sonification', 'collisionless plasma', 'magnetic resonance imaging', 'geovisual analytics', 'augmented reality', 'data visualization', 'rendering', 'virtual reality', 'visual analytics', 'computer graphics', 'image processing', 'science education', 'evaluation', 'high dynamic range imaging', 'coordination', 'human-centered computing', 'calibration', 'deep learning', 'pic simulation', 'conceptual understanding']
keyword2= ['science education', 'visualization', 'shock', 'deep learning', 'visualization application domains', 'scientific visualization', 'medical visualization', 'parallel coordinates', 'volume rendering', 'transfer function', 'air traffic control', 'quantification', 'information visualization', 'user interfaces', 'machine learning', 'visualization design and evaluation methods', 'categorical data', 'pic simulation', 'human-centered computing', 'haptics', 'geovisual analytics', 'threshold concepts', 'automation', 'collisionless plasma', 'protein-ligand docking', 'visual clutter', 'digital pathology', 'life science education', 'video see-through', 'calibration', 'evaluation', 'stereoscopic displays', 'storytelling', 'label placement', 'science education research', 'evolution', 'visual analytics', 'protein interactions', 'augmented reality', 'sonification', 'virtual reality']
keyword3= ['augmented reality', 'whole slide imaging', 'cancer', 'complex development projects', 'text visualization', 'pathology', 'visual clutter', 'self-organizing network', 'protein interactions', 'boresight', 'stereoscopic displays', 'machine learning', 'molecular life science', 'multi-layer', 'visualization design and evaluation methods', 'collisionless plasma', 'protein-ligand docking', 'digital design', 'information visualization', 'user interfaces', 'visual analytics', 'line of sight', 'calibration', 'scientific visualization', 'visualization application domains', 'pic simulation', 'artificial neural networks', 'time-varying', 'coordination', 'images', 'weather prediction data', 'science education research', 'label placement', 'interaction design', 'shock', 'virtual reality', 'human-centered computing', 'haptics', 'relativistic jet', 'postural sway', 'life science education', 'image synthesis', 'science education', 'visualization']
...
for _, row in time_df.iterrows():
    ...
    if row_keywords is not np.nan:
        ...
        for keyword in row_keywords:
            # If the keyword is in the list of keywords to check
