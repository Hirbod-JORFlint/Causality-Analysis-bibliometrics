...
keyword1= ['imaging', 'visual analytics', 'interfac', 'air', 'management', 'inform', 'user', 'visual', 'automation', 'activ', 'machine learning', 'evaluation', 'rendering', 'shock', 'interact', 'volume', 'deep', 'design', 'plasma', 'graphic', 'visualization', 'patholog', 'image', 'computer', 'virtual', 'learn', 'science', 'scientific', 'physic', 'systems', 'educ', 'haptic', 'realiti', 'machine', 'simulation', 'light', 'augmented', 'information visualization', 'control', 'comput', 'analyt', 'pic', 'sonification', 'technology', 'traffic', 'data', 'digital', 'analysis', 'video', 'color']
keyword2= ['management', 'science', 'traffic', 'plasma', 'color', 'technology', 'air', 'computer', 'graphic', 'simulation', 'analyt', 'evaluation', 'physic', 'deep', 'learn', 'volume', 'design', 'visualization', 'educ', 'interact', 'methods', 'machine', 'inform', 'theori', 'control', 'human-cent', 'realiti', 'scientific', 'systems', 'analysis', 'comput', 'virtual', 'visual', 'shock', 'artificial', 'pic', 'rendering', 'intelligence', 'data', 'augmented', 'activ']
keyword3= ['supernova', 'astrophys', 'visual', 'vision', 'systems', 'computer', 'color', 'human-cent', 'remnants', 'wave', 'scientific', 'plasma', 'simulation', 'data', 'evaluation', 'space', 'visualization', 'tra?c', 'analyt', 'traffic', 'method', 'architectur', 'inform', 'development', 'domains', 'activ', 'management', 'air', 'control', 'graphics]:', 'rendering', 'design', 'theori', 'comput', 'computers', '[computer', 'application', 'methods', 'temperature']
