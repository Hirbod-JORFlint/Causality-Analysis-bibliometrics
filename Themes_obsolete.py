...
# One-liner cheat
lda_model = gensim.models.LdaModel(corpus, num_topics=6, id2word=dictionary, passes=40, iterations=5000, random_state=2, eval_every=50);vis = gensimvis.prepare(lda_model, corpus, dictionary, mds='tsne', n_jobs=-1); pyLDAvis.save_html(vis, 'lda_visualization.html')
